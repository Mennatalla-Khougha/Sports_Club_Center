...
player1 = Player(first_name='george', last_name="raafat", gender='M', birth_day=date(2004, 9, 29))
player2 = Player(first_name='manna', last_name="k", gender='F', birth_day=date(1994, 5, 11))


sport1 = Sport(name='tennis')
sport2 = Sport(name='squash')

tournament_tennis = Tournament(sport_id=sport1.id, name="my tournament", date=datetime(2023, 12, 15, 17, 30, 0), age_range="15-20")
