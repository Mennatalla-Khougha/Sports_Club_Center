...
fetch(api)
  ...
  .then((data) => {
    for (const tournament of data) {
      ...
      text += `<img src="/static/club/images/tournaments/${tournament.id}.png" onerror="this.onerror=null; this.src='/static/club/images/tournaments/${tournament.sport}.png'" alt="${tournament.sport} Tournament" />`;
      text += `</div>`;
