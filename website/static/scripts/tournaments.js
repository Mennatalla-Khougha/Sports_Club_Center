...
fetch(api)
  ...
  .then((data) => {
    for (const tournament of data) {
      ...
      text += `<img src="../static/personal_images/${tournament.id}.png" onerror="this.onerror=null; this.src='../static/personal_images/no_pic.png'" alt="${tournament.sport} tournament" />`;
      text += `</div>`;
